...
exports.viewLastestIdeas = async (req, res) => {
  if (req.session.email === undefined) {
    ...
    try {
      ...
      res.render("student/viewLastestIdeas", {
        lastestIdeas: lastestIdeas,
        loginName: req.session.email,
      });
    } catch (e) {
      console.log(e);
...
exports.viewMostComments = async (req, res) => {
  if (req.session.email === undefined) {
    ...
    try {
      ...
      res.render("student/viewMostComments", {
    ...
    try {
      ...
      for (let comment of last_comments) {
        ...
        if (objIdea === null || objAuthor === null) {
          if (objIdea === null) console.log("Idea lost: ", comment.ideaID);
      ...
      res.render("student/viewLatestComments", {
        lastComments_detail: lastComments_detail,
        loginName: req.session.email,
      });
    } catch (err) {
      console.log(err);
...
exports.filterLatestComment = async (req, res) => {
  if (req.session.email === undefined) {
    ...
    try {
      ...
      res.render("qac/viewLastestComment", {
        lastComments_detail: lastComments_detail,
        loginName: req.session.email,
      });
    } catch (err) {
...
exports.viewMostViewedIdeas = async (req, res) => {
  if (req.session.email === undefined) {
    ...
    try {
      ...
      res.render("student/viewMostViewedIdeas", {
        mostViewedIdeas: mostViewedIdeas,
        loginName: req.session.email,
      });
    } catch (e) {
